...
namespace Teste
{
    public class ProdutoTeste
    {
        ...
        /*
        Eu, como almoxarife, preciso cadastras produtos para que sejam consumidos pelos funcionários
        da empresa.

        Critérios de aceite?
        1 - Um novo produto deve ter obrigatóriamente um código único, nome, saldo 0, custo 0 e unidade 
        de medida.
        ...
        */
        ...
        public void CriarObjeto()
        {
            ...
            /*
             * Primeira forma - usando variáveis
             * 
            int codigo = 1;
            string nome = "Caneca";
            double saldo = 0;
            ...
            */
            ...
            /*
             * Quarta forma - usando objeto anônimo e ExpetedObject
             */
            var obj = new
            {
                Codigo = this._codigo,
        ...
        public void SaldoInvalido(int saldoInvalido)
        {
            ...
            */
            ...
            Assert.Equal("Saldo inválido", mensagem);
        }
